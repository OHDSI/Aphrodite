...
studyName <-'FH_test20'   #String for saving objects prefix
outcomeName <- 'FH_test20' #String for model objects prefix
...
saveFolder = "/home/kniehaus/Intermediate_data/FH_test20/"
