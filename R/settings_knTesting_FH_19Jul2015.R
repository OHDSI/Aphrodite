...
studyName <-'FH_test300_post'   #String for saving objects prefix
outcomeName <- 'FH_test300_post' #String for model objects prefix
nCases = 300 # Number of patients to use as cases
nControls = 300 #Number of patients to use as controls
...
flag$model[1] <-'LASSO' # Available types: LASSO, RF
### How to use features ###
...
saveFolder = "/home/kniehaus/Intermediate_data/FH_test300/"
