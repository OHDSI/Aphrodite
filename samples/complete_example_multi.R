...
###################################################################################################
### This step creates a loop to cycle through a couple of models - MI and T2DM in this example  ###
###                                                                                             ###
### A more elegant solution could be done, but this gets the job done quickly                   ###
###                                                                                             ###
###################################################################################################

models_to_build <-2

for (model_loop in 1:models_to_build) {
    ...
    cat(aphrodite_concept_name, " model has been built", "\n")
}
